...
class Nano {
     ...
     */
    public static function finilize()
    {
    ...
    public static function app()
    {
        if(Nano::$application == NULL)
            Nano::$application = new NWebApplication();
    ...
    private static function hooks()
    {
        ...
        if($hooks)
            foreach($hooks as $hook)
            {
                ...
                Nano::import($hook[0]);
                call_user_method($hook[1], $class, $hook[3]);
            }
    }
    ...
    {
        Nano::$classes = array_merge(NFramework::import($package),Nano::$classes);
    }
    ...
    private static function autoload($class)
    {
        ...
        {
            $load = NFramework::resolve(Nano::$classes[$class]);
            if(file_exists($load))
            {
                include($load);
                return true;
