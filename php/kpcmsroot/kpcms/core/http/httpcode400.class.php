...
class HTTPCode400 extends HttpCode
{
	public function __construct($mdata)
	{
		if(get_class($mdata) !== 'HTTPMessageData')
			throw new Exception('Argument 1 to method HTTPCode400::__construct() not a class HTTPMessageData!');
			
		$t = NULL;
		parent::AddHeader('HTTP/1.1 400 Bad Request');
